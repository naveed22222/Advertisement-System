"""
Django settings for advertising_system project.
...
SECRET_KEY = 'django-insecure-f9^f64@69q@-aj1@f_(uba)o7e+lx%ikvbs3%g$3%w690kn*qf'
...
WSGI_APPLICATION = 'advertising_system.wsgi.application'
